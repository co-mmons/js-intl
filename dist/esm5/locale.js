...
export var localeIntlBundleItem = { path: "node_modules/@umpirsky/locale-list/data/{{LOCALE}}/locales.json", type: "message", namespace: "@umpirsky/locale-list" };
/**
 * https://en.wikipedia.org/wiki/IETF-language-tag
 */
var Locale = /** @class */ (function () {
    function Locale(codeOrPrototype) {
        this.$constructor(codeOrPrototype);
    }
    Locale.prototype.$constructor = function (codeOrPrototype) {
    ...
    Locale.prototype.fromJSON = function (json) {
